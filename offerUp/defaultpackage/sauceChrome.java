...
public class sauceChrome{
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		driver.findElementByClassName("c_header__mobile-bt mobile-bt--search udi udi-search").click();
		
		driver.findElementByXPath("//input[@type = 'text']").sendKeys("SOAP UI");
